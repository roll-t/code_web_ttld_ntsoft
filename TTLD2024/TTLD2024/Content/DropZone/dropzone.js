                        ...
                        return function () {
                            ...
                            return function () {
                                ...
                                var s = {
                                    ...
                                    renameFile: null,
                                    forceFallback: !1,
                                    dictDefaultMessage: "Kéo tệp vào đây để tải lên",
                                    dictFallbackMessage: "Trình duyệt của bạn không hỗ trợ kéo thả tệp.",
                                    dictFallbackText: "Please use the fallback form below to upload your files like in the olden days.",
                                    dictFileTooBig: "Dung lượng tệp quá lớn ({{filesize}}MiB). Dung lượng tối đa: {{maxFilesize}}MiB.",
                                    dictInvalidFileType: "Định dạng tệp không hỗ trợ.",
                                    dictResponseError: "Máy chủ phản hồi mã {{statusCode}}.",
                                    dictCancelUpload: "Hủy tải lên",
                                    dictUploadCanceled: "Đã hủy tải lên.",
                                    dictCancelUploadConfirmation: "Bạn có chắc chắn hủy tải lên",
                                    dictRemoveFile: "Xóa tệp",
                                    dictRemoveFileConfirmation: null,
                                    dictMaxFilesExceeded: "Vượt quá giới hạn số lượng tệp tải lên.",
                                    dictFileSizeUnits: {
                                        tb: "TB",
                                        gb: "GB",
                                        mb: "MB",
                                    ...
                                    addedfile: function (e) {
                                        ...
                                        if (this.element === this.previewsContainer && this.element.classList.add("dz-started"),
                                            ...
                                            this.options.addRemoveLinks && (e._removeLink = b.createElement('<a class="dz-remove" href="javascript:undefined;" data-dz-remove data="' + e.name +'">'.concat(this.options.dictRemoveFile, "</a>")),

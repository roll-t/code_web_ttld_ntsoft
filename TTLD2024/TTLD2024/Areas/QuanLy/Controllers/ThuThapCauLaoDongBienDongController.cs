...
namespace TTLD2024.Areas.QuanLy
{
    public class ThuThapCauLaoDongBienDongController : Controller
    {
        // GET: QuanLy/ThuThapCauLaoDongBienDong
        ...
        public string GetAll(object[] data)
        {
            ...
            try
            {
                ...
                DataTable duLieu = SqlHelper.ExecuteDataset(NTSSession.GetConnectionString2(), "Proc_GetAllCauLaoDongBienDong", para).Tables[0];
        ...
        public string CanhBaoDuLieuChuaHoanThanh(object[] data)
        {
            ...
            try
            {
                ...
                DataTable duLieu = SqlHelper.ExecuteDataset(NTSSession.GetConnectionString2(), "Proc_CanhBaoDuLieuChuaHoanThanhBienDong", para).Tables[0];
        ...
        public string LuuThongTinBuoc1(object[] data)
        {
            try
            {
                ...
                DataSet duLieuCauLaoDong = SqlHelper.ExecuteDataset(NTSSession.GetConnectionString1(), "Proc_LuuThongTinCauLaoDongBienDong", para);
                if (Loai == "them")
                {
                    SqlParameter[] para2 = {
        ...
        public string XoaDuLieu(string id)
        {
            try
            {
                ...
                DataSet duLieu = SqlHelper.ExecuteDataset(NTSSession.GetConnectionString1(), "Delete_CauLaoDongBienDong", para);
        ...
        public string LoadDuLieuSua(string id)
        {
            ...
            try
            {
                ...
                DataTable duLieu = SqlHelper.ExecuteDataset(NTSSession.GetConnectionString1(), "Proc_GetAllCauLaoDongBienDongByID", para).Tables[0];
                ep.Result = duLieu;
                return JSonHelper.ToJson(ep);
            }
            catch (Exception ex)
        ...
        public string LoadDuLieuSua_Buoc3(string id)
        {
            ...
            try
            {
                ...
                DataTable duLieu = SqlHelper.ExecuteDataset(NTSSession.GetConnectionString1(), "Proc_GetAllCauLaoDongBienDongByID_Buoc3", para).Tables[0];
                ep.Result = duLieu;
                return JSonHelper.ToJson(ep);
            }
            catch (Exception ex)
        ...
        public string LuuThongTinBuoc3(object[] data)
        {
            try
            {
                ...
                DataSet duLieu = SqlHelper.ExecuteDataset(NTSSession.GetConnectionString1(), "Proc_UpdateCauLaoDongBienDong_Buoc3", para);
                if (Loai == "them")
                {
                    duLieu.Tables[0].TableName = "CauLaoDong";
                    NTSSecurity.ghiLogs(duLieu.Tables[0], "Sua");
        ...
        [HttpPost]
        public string XuatExcel_DSThuThapCauLaoDongBienDong(object[] data)
        {
            ExecPermiss ep = new ExecPermiss();
            try
            {
                ...
                string fileName = "ThuThapCauLaoDongBienDong" + nameExcel + ".xlsx";
                string fileMau = Server.MapPath("~/ExcelMau/NghiepVu/DanhSachThuThapCauLaoDongBienDong.xlsx");
                string fileKQ = Server.MapPath("~/xuatexcel" + "/" + nameExcel + "/NghiepVu/DanhSachThuThapCauLaoDongBienDong/" + fileName);
                string url = "~/xuatexcel" + "/" + nameExcel + "/NghiepVu/DanhSachThuThapCauLaoDongBienDong/";
                string KetQua = "";
                SqlParameter[] para = {
                    new SqlParameter("@TinhID_TimKiem_us", DungChung.NormalizationGuid(data[0].ToString())),
                    new SqlParameter("@HuyenID_TimKiem_us", DungChung.NormalizationGuid(data[1].ToString())),
                ...
                DataTable duLieu = SqlHelper.ExecuteDataset(NTSSession.GetConnectionString2(), "Proc_GetAllCauLaoDongBienDong_Excel", para).Tables[0];
                ...
                wb.Save();
                KetQua = "/xuatexcel/" + nameExcel + "/NghiepVu/DanhSachThuThapCauLaoDongBienDong/" + fileName;
        ...
        public string LoadDuLieuToChucTheoMaSoThue(string value)
        {
            ...
            try
            {
                ...
                DataTable duLieu = SqlHelper.ExecuteDataset(NTSSession.GetConnectionString1(), "Proc_GetAllToChucByMaSoThue_DaThuThapBanDau", para).Tables[0];
                ep.Result = duLieu;
                return JSonHelper.ToJson(ep);
            }
            catch (Exception ex)
        ...
        [HttpPost]
        public string LoadDuLieuToChucTheoMaSoThue_ChuaThuThap(string value)
        {
            ExecPermiss ep = new ExecPermiss();
            try
            {
                ...
                DataTable duLieu = SqlHelper.ExecuteDataset(NTSSession.GetConnectionString1(), "Proc_GetAllToChucByMaSoThueBienDong", para).Tables[0];
                ep.Result = duLieu;
                return JSonHelper.ToJson(ep);
            }
            catch (Exception ex)
        ...
        [HttpPost]
        public string LoadDuLieuCauLaoDongTheoMaSoThue(string id)
        {
            ExecPermiss ep = new ExecPermiss();
            try
            {
                ...
                DataTable duLieu = SqlHelper.ExecuteDataset(NTSSession.GetConnectionString1(), "Proc_GetAllCauLaoDongBy_MaSoThue", para).Tables[0];
                ep.Result = duLieu;
                return JSonHelper.ToJson(ep);
            }
            catch (Exception ex)
        ...
        [HttpPost]
        public string LuuThongTinCauBanDauSangBienDong(object[] data)
        {
            try
            {
                ExecPermiss ep = new ExecPermiss();
                ...
                SqlParameter[] para = {
                    ...
                    new SqlParameter("@ViDo", DungChung.NormalizationString(data[29].ToString())),
                    new SqlParameter("@NamThuThap", DungChung.NormalizationNumber(NTSSession.GetNamSudung())),
                    new SqlParameter("@txtDinhKem_VanBan_US", DungChung.NormalizationString(data[33].ToString())),
                    new SqlParameter("@txtDuongDanFileChuKy", DungChung.NormalizationString(data[34].ToString())),
                    new SqlParameter("@KyTen_us", DungChung.NormalizationString(data[35].ToString())),
                    new SqlParameter("@DonViID", DungChung.NormalizationGuid(NTSSession.GetDonVi().DonViID)),
                    new SqlParameter("@UserID", DungChung.NormalizationGuid(NTSSession.GetUser().UserID)),
                };
                DataSet duLieuCauLaoDong = SqlHelper.ExecuteDataset(NTSSession.GetConnectionString1(), "Proc_LuuThongTinCauLaoDongBanDauSangBienDong", para);
                if (Loai == "them")
                {
                    SqlParameter[] para2 = {
                        new SqlParameter("@CauLaoDongID", DungChung.NormalizationGuid( duLieuCauLaoDong.Tables[0].Rows[0]["CauLaoDongID"].ToString())),
                        new SqlParameter("@CauLaoDongBanDauID", DungChung.NormalizationGuid( data[31].ToString()))
                    };
                    DataSet duLieuMau = SqlHelper.ExecuteDataset(NTSSession.GetConnectionString1(), "Proc_DoDuLieuMau_Vao_CauLaoDongTTLD_DaThuThap", para2);
                    DataSet duLieuTyenDung = SqlHelper.ExecuteDataset(NTSSession.GetConnectionString1(), "Proc_GetAllTTCauLDBanDauTD_DaThuThap", para2);
                    duLieuCauLaoDong.Tables[0].TableName = "CauLaoDong";
                    NTSSecurity.ghiLogs(duLieuCauLaoDong.Tables[0], "Them");
                    ep.Result = duLieuCauLaoDong.Tables[0].Rows[0]["CauLaoDongID"].ToString();
                    ep.Msg = "Lưu dữ liệu thành công!";
        ...
        public string NoiDungThuThapCT(string id)
        {
            try
            {
                ...
                SqlParameter[] para = {
                    new SqlParameter("@CauLaoDongID",Class.DungChung.NormalizationGuid(id)),
                };
                DataTable duLieu = SqlHelper.ExecuteDataset(NTSSession.GetConnectionString2(), "Proc_GetNoiDungThuThapCT", para).Tables[0];
                var customerData = duLieu.AsEnumerable();
                ep.Result = duLieu;
                return JSonHelper.ToJson(ep);
            }

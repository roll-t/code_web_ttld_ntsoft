...
! function (a) {
    ...
    c.prototype = {
        ...
        setState: function () {  
            ...
            var stp = this.currentStep; 
            $('[msg-step]').each(function () {
                if ($(this).context.getAttribute("msg-step") == stp) {
                    $(this).show();
                }
                else {
                    $(this).hide();
            ...
            this.options.disablePreviousStep || this.$prevBtn.attr("disabled", false);

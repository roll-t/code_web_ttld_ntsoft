...
{
    public class NguoiNNLVVNController : Controller
    {
        // GET: QuanLy/NguoiNNLVVN
        ...
        public string GetAll(object[] data)
        {
            ...
            try
            {
                ...
                SqlParameter[] para = {
                    ...
                    new SqlParameter("@NamTrongKCN", DungChung.NormalizationBoolean(data[8])),
                };
                DataTable duLieu = SqlHelper.ExecuteDataset(NTSSession.GetConnectionString2(), "Proc_GetAllNguoiNNLVN", para).Tables[0];
        ...
        public string LuuThongTin(object[] data)
        {
            try
            {
                ...
                SqlParameter[] para = {
                    ...
                    new SqlParameter("@NguoiNNLVVNID", DungChung.NormalizationGuid(data[1].ToString())),
                    new SqlParameter("@DoiTuongNNID",DungChung.NormalizationGuid(data[3].ToString())),
                    new SqlParameter("@NgayThuThapDoiTuongNN_usTT",DungChung.NormalizationDateTime( data[2].ToString())),
                    new SqlParameter("@ToChucID",DungChung.NormalizationGuid( data[4].ToString())),
                    new SqlParameter("@TrinhDoCMKTIDDoiTuongNNTT_us", DungChung.NormalizationGuid(data[11].ToString())),
                    new SqlParameter("@ChuyenNganhDaoTaoDoiTuongNNTT_us", DungChung.NormalizationGuid(data[12].ToString())),
                    new SqlParameter("@NoiDungThuThapDoiTuongNNTT_us", DungChung.NormalizationString(data[15].ToString())),
                    new SqlParameter("@SoGPLDDoiTuongNNTT_us", DungChung.NormalizationGuid(data[16].ToString())),
                    new SqlParameter("@DiaChiDoiTuongNNTT_us", DungChung.NormalizationString(data[18].ToString())),
                    new SqlParameter("@ViTriCongViecDoiTuongNNTT_us", DungChung.NormalizationGuid(data[20].ToString())),
                    new SqlParameter("@NgheCongViecDoiTuongNNTT_us", DungChung.NormalizationGuid(data[21].ToString())),
                    new SqlParameter("@ThoiGianLVTuNgayDoiTuongNNTT_us", DungChung.NormalizationDateTime(data[22].ToString())),
                    new SqlParameter("@ThoiGianLVDenNgayDoiTuongNNTT_us", DungChung.NormalizationDateTime(data[23].ToString())),
                    new SqlParameter("@txtDinhKem_NguoiNNLVVN_US", DungChung.NormalizationString(data[24].ToString())),
                    new SqlParameter("@txtDuongDanFileChuKy", DungChung.NormalizationString(data[25].ToString())),
                    new SqlParameter("@KyTen_us", DungChung.NormalizationString(data[26].ToString())),
                    new SqlParameter("@TrangThaiDoiTuongNN_us", DungChung.NormalizationBoolean(data[27].ToString())),
                    new SqlParameter("@HinhTucLamViecIDDoiTuongNNTT_us", DungChung.NormalizationGuid(data[28].ToString())),
                ...
                DataSet duLieu = SqlHelper.ExecuteDataset(NTSSession.GetConnectionString1(), "Proc_LuuThongTinNguoiNNLVVN", para);
                if (Loai == "them")
                {
        ...
        [HttpPost]
        public string LuuThongTin_DoiTuongThayDoi(object[] data)
        {
            try
            {
                ExecPermiss ep = new ExecPermiss();
                ...
                try
                {
                    SqlParameter[] paraDT = {
                        new SqlParameter("@DoiTuongNNID",DungChung.NormalizationGuid(data[3].ToString())),
                        new SqlParameter("@MaSoDoiTuongNNTT_us", DungChung.NormalizationString(data[5].ToString())),
                        new SqlParameter("@drop_MaSo_usTT", DungChung.NormalizationString(data[6].ToString())),
                        new SqlParameter("@NgayCapDoiTuongNNTT_us", DungChung.NormalizationDateTime(data[8].ToString())),
                        new SqlParameter("@CoGiaTriDoiTuongNNTT_us", DungChung.NormalizationDateTime(data[9].ToString())),
                        new SqlParameter("@NoiCapDoiTuongNNTT_us", DungChung.NormalizationGuid(data[10].ToString())),
                        new SqlParameter("@SoDienThoaiDoiTuongNN_us", DungChung.NormalizationString(data[13].ToString())),
                        new SqlParameter("@EmailDoiTuongNNTT_us", DungChung.NormalizationString(data[14].ToString())),
                        new SqlParameter("@DonViID", DungChung.NormalizationGuid(NTSSession.GetDonVi().DonViID)),
                        new SqlParameter("@UserID", DungChung.NormalizationGuid(NTSSession.GetUser().UserID)),
                    };
                    DataSet duLieuDT = SqlHelper.ExecuteDataset(NTSSession.GetConnectionString1(), "Update_DoiTuongNN", paraDT);
                }catch (Exception ex) { }
                ...
                SqlParameter[] para = {
                    ...
                    new SqlParameter("@NgayThuThapDoiTuongNN_usTT",DungChung.NormalizationDateTime( data[2].ToString())),
                    new SqlParameter("@ToChucID",DungChung.NormalizationGuid( data[4].ToString())),
                    new SqlParameter("@TrinhDoHVDoiTuongNNTT_us", DungChung.NormalizationGuid(data[11].ToString())),
                    new SqlParameter("@ChuyenNganhDaoTaoDoiTuongNNTT_us", DungChung.NormalizationGuid(data[12].ToString())),
                    new SqlParameter("@NoiDungThuThapDoiTuongNNTT_us", DungChung.NormalizationString(data[15].ToString())),
                    new SqlParameter("@SoGPLDDoiTuongNNTT_us", DungChung.NormalizationGuid(data[16].ToString())),
                    new SqlParameter("@DiaChiDoiTuongNNTT_us", DungChung.NormalizationString(data[18].ToString())),
        ...
        [HttpPost]
        public string LuuThongTin_ToChucVaDoiTuongThayDoi(object[] data)
        {
            try
            {
                ExecPermiss ep = new ExecPermiss();
                ...
                {
                    SqlParameter[] paraTC = {
                        new SqlParameter("@ToChuc",DungChung.NormalizationGuid(data[4].ToString())),
                        new SqlParameter("@LoaiHinhDNIDDoiTuongNNTT_us", DungChung.NormalizationGuid(data[19].ToString())),
                        new SqlParameter("@DonViID", DungChung.NormalizationGuid(NTSSession.GetDonVi().DonViID)),
                        new SqlParameter("@UserID", DungChung.NormalizationGuid(NTSSession.GetUser().UserID)),
                    };
                    SqlParameter[] paraDT = {
                    ...
                    DataSet duLieuTC = SqlHelper.ExecuteDataset(NTSSession.GetConnectionString1(), "Update_ToChuc", paraTC);
                    DataSet duLieuDT = SqlHelper.ExecuteDataset(NTSSession.GetConnectionString1(), "Update_DoiTuongNN", paraDT);
                }
                catch(Exception ex)
                {
        ...
        [HttpPost]
        public string LuuThongTin_ToChucThayDoi(object[] data)
        {
            try
            {
                ExecPermiss ep = new ExecPermiss();
        ...
        [HttpPost]
        public string XuatExcel_DSNguoiNNLVVN(object[] data)
        {
            ExecPermiss ep = new ExecPermiss();
            try
            {
                ...
                string fileName = "DanhSachLaoDongNuocNgoaiLVVN" + nameExcel + ".xlsx";
                string fileMau = Server.MapPath("~/ExcelMau/NghiepVu/DanhSachLaoDongNuocNgoaiLVVN.xlsx");
                string fileKQ = Server.MapPath("~/xuatexcel" + "/" + nameExcel + "/NghiepVu/DanhSachLaoDongNuocNgoaiLVVN/" + fileName);
                string url = "~/xuatexcel" + "/" + nameExcel + "/NghiepVu/DanhSachLaoDongNuocNgoaiLVVN/";
                string KetQua = "";
                SqlParameter[] para = {
                    new SqlParameter("@TinhID_TimKiem_us", DungChung.NormalizationGuid(data[0].ToString())),
                    new SqlParameter("@HuyenID_TimKiem_us", DungChung.NormalizationGuid(data[1].ToString())),
                ...
                DataTable duLieu = SqlHelper.ExecuteDataset(NTSSession.GetConnectionString2(), "Proc_GetAllNguoiNNLVN_Execl", para).Tables[0];
                ...
                if (duLieu.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dr in duLieu.Rows)
                    {
                        ...
                        ws.Cell("I" + vDongXuat).Value = "'" + dr["TenTrinhDo"].ToString();
                        ws.Cell("J" + vDongXuat).Value = "'" + dr["TenChuyenNganhDT"].ToString();
                        ws.Cell("K" + vDongXuat).Value = "'" + dr["SoGiayPhep"].ToString();
                        ws.Cell("L" + vDongXuat).Value = "'" + dr["DiaDiemLV"].ToString();
                        ws.Cell("M" + vDongXuat).Value = "'" + dr["ThoiHanLV"].ToString();
                ...
                wb.Save();
                KetQua = "/xuatexcel/" + nameExcel + "/NghiepVu/DanhSachLaoDongNuocNgoaiLVVN/" + fileName;
        ...
        public string LoadDuLieuSua(string id)
        {
            ...
            try
            {
                ...
                DataTable duLieu = SqlHelper.ExecuteDataset(NTSSession.GetConnectionString1(), "Proc_GetAllNguoiNNLVVNByID", para).Tables[0];
                ep.Result = duLieu;
                return JSonHelper.ToJson(ep);
            }
            catch (Exception ex)
        ...
        [HttpPost]
        public string LoadDuLieuDoiTuongNNBySoHoChieu(string soHoChieu)
        {
            ExecPermiss ep = new ExecPermiss();
            try
            {
                SqlParameter[] para = {
                    new SqlParameter("@SoHoChieu", DungChung.NormalizationString(soHoChieu)),
                };
                DataTable duLieu = SqlHelper.ExecuteDataset(NTSSession.GetConnectionString1(), "Proc_GetAllDoiTuongNN_BySoHoChieu", para).Tables[0];
                ep.Result = duLieu;
                return JSonHelper.ToJson(ep);
            }
            catch (Exception ex)
        ...
        [HttpPost]
        public string LoadDuLieuToChucByMaSoThue(string maSoThue)
        {
            ExecPermiss ep = new ExecPermiss();
            try
            {
                SqlParameter[] para = {
                    new SqlParameter("@MaSoThue", DungChung.NormalizationString(maSoThue)),
                };
                DataTable duLieu = SqlHelper.ExecuteDataset(NTSSession.GetConnectionString1(), "Proc_GetAllToChucMaSoThue_NguoiNNLVVN", para).Tables[0];
                ep.Result = duLieu;
                return JSonHelper.ToJson(ep);
            }
            catch (Exception ex)

...
{
    public class ThuThapCungLaoDongBanDauController : Controller
    {
        // GET: QuanLy/ThuThapCungLaoDongBanDau
        ...
        public string GetAll(object[] data)
        {
            ...
            try
            {
                ...
                DataTable duLieu = SqlHelper.ExecuteDataset(NTSSession.GetConnectionString2(), "Proc_GetAllCungLaoDong", para).Tables[0];
        ...
        public string LuuThongTin(object[] data)
        {
            try
            {
                ...
                SqlParameter[] para = {
                    ...
                    new SqlParameter("@ChuKy", DungChung.NormalizationString(data[58].ToString())),
        ...
        public string XoaDuLieuCungLaoDong(string id)
        {
            try
            {
                ...
                string pathAnhDaiDien1 = DungChung.LayDuongDanDinhKem("CungLaoDong", "ChuKy", "CungLaoDongID", id);
                string pathAnhDaiDien2 = DungChung.LayDuongDanDinhKem("CungLaoDong", "DinhKem", "CungLaoDongID", id);
        ...
        public string LoadDuLieuSua(string id)
        {
            ...
            try
            {
                ...
                DataTable duLieu = SqlHelper.ExecuteDataset(NTSSession.GetConnectionString1(), "Proc_GetAllCungLaoDongBanDauByID", para).Tables[0];
                ep.Result = duLieu;
                return JSonHelper.ToJson(ep);
            }
            catch (Exception ex)
        ...
        [HttpPost]
        public string XuatExcel_DSThuThapCungLaoDongBanDau(object[] data)
        {
            ExecPermiss ep = new ExecPermiss();
            try
            {
                SqlFunction sqlFun = new SqlFunction(NTSSession.GetConnectionString2());
                string nameExcel = DungChung.RemoveDiacritics(NTSSession.GetDonVi().TenDonVi + NTSSession.GetDonVi().MaDonVi);
                string fileName = "ThuThapCungLaoDongBanDau" + nameExcel + ".xlsx";
                string fileMau = Server.MapPath("~/ExcelMau/NghiepVu/DanhSachThuThapCungLaoDongBanDau.xlsx");
                string fileKQ = Server.MapPath("~/xuatexcel" + "/" + nameExcel + "/NghiepVu/DanhSachThuThapCungLaoDongBanDau/" + fileName);
                string url = "~/xuatexcel" + "/" + nameExcel + "/NghiepVu/DanhSachThuThapCungLaoDongBanDau/";
                string KetQua = "";
                SqlParameter[] para = {
                    new SqlParameter("@TinhID_TimKiem_us", DungChung.NormalizationGuid(data[0].ToString())),
                    new SqlParameter("@HuyenID_TimKiem_us", DungChung.NormalizationGuid(data[1].ToString())),
                ...
                DataTable duLieu = SqlHelper.ExecuteDataset(NTSSession.GetConnectionString2(), "Proc_GetAllCungLaoDong_Excel", para).Tables[0];
                ...
                if (duLieu.Rows.Count > 0)
                {
                    ...
                    {
                        stt += 1;
                        ws.Range("A" + vDongXuat + ":V" + vDongXuat).Style.Alignment.SetWrapText(true).Border.SetTopBorder(XLBorderStyleValues.Dashed).Border.SetBottomBorder(XLBorderStyleValues.Dashed).Border.SetLeftBorder(XLBorderStyleValues.Thin).Border.SetRightBorder(XLBorderStyleValues.Thin);
                    ...
                    ws.Range("A" + vDongXuat + ":V" + vDongXuat).Style.Font.SetBold(true).Border.SetTopBorder(XLBorderStyleValues.Thin);
                ...
                wb.Save();
                KetQua = "/xuatexcel/" + nameExcel + "/NghiepVu/DanhSachThuThapCungLaoDongBanDau/" + fileName;
